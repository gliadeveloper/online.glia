...
export function MarkdownComposer({
  ...
  return (
    <div className={isPlain ? "lesson-markdown-composer" : "community-markdown-field"}>
      <label
        htmlFor={id}
        className={
          isPlain
            ? "mb-2 block text-sm font-medium text-zinc-900"
            : "community-markdown-field__label"
        }
      >
        {label}
      </label>
      ...
      <textarea
        ...
        className={
          isPlain
            ...
            : "community-markdown-field__textarea corp-trust-focus shell-focus-ring"
        }
      />
      ...
      <div
        className={
          isPlain
            ...
            : "community-markdown-field__meta"
        }
      >
